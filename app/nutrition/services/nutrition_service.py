...
class NutritionService:
    ...
    def get_meal_distribution(meals_per_day: int) -> Dict[str, float]:
        distributions = {
            3: {
                "Завтрак": 0.3,
                "Обед": 0.4,
    ...
    def select_dish(filtered_dishes: List[DishModel], meal_type: str) -> DishModel:
        suitable_dishes = [
            dish for dish in filtered_dishes 
            if dish.category.value == meal_type
        ]
